      ...
      {isOpen && (
        <div className="absolute right-0 top-full mt-2 w-64 bg-[#0a0a0a] border border-[#1a1a1a] z-50">
          ...
          <div className="p-3 flex justify-between">
            <a href="/docs" className="text-xs text-gray-500 hover:text-white">[docs]</a>
            <button
...
export function Dashboard({
  ...
  return (
    <div className="flex-1 flex flex-col">
      {/* Header is in layout, this is the main content */}
      ...
      {/* Toast notification area - fixed bottom right */}
      <div className="fixed bottom-6 right-6 space-y-2">
        {/* Example toast - would be dynamic */}
        {/*
        <div className="bg-[#111] border border-[#1a1a1a] px-4 py-3 flex items-center gap-3">
          <span className="w-2 h-2 bg-[#4ADE80] rounded-full" />
