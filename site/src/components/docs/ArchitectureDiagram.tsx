export function ArchitectureDiagram() {
  return (
    <svg width="520" height="400" viewBox="0 0 420 320" className="my-6">
      ...
      {/* Train on Aztec */}
      <rect x="255" y="65" width="125" height="40" rx="3" fill="#111" stroke="#A855F7" strokeWidth="1"/>
      <text x="317" y="90" fill="#A855F7" fontFamily="monospace" fontSize="11" textAnchor="middle">Train HTLC</text>

      {/* Arrow from balance to train */}
      <line x1="175" y1="85" x2="250" y2="85" stroke="#666" strokeWidth="1.5" markerEnd="url(#arrow-gray)"/>
      ...
      <text x="105" y="215" fill="#ccc" fontFamily="monospace" fontSize="11" textAnchor="middle">Fresh Address</text>

      {/* Train on Base */}
      <rect x="255" y="190" width="125" height="40" rx="3" fill="#111" stroke="#A855F7" strokeWidth="1"/>
      <text x="317" y="215" fill="#A855F7" fontFamily="monospace" fontSize="11" textAnchor="middle">Train HTLC</text>

      {/* Arrow from train to fresh */}
      <line x1="250" y1="210" x2="175" y2="210" stroke="#666" strokeWidth="1.5" markerEnd="url(#arrow-gray)"/>

      {/* zkp2p inside BASE */}
      <rect x="35" y="250" width="120" height="35" rx="3" fill="#111" stroke="#4ADE80" strokeWidth="1"/>
      <image x="42" y="257" width="22" height="22" href="/zkp2p-logo.png"/>
      <text x="105" y="273" fill="#4ADE80" fontFamily="monospace" fontSize="12" textAnchor="middle">zkp2p</text>
      ...
      <line x1="317" y1="110" x2="317" y2="185" stroke="#A855F7" strokeWidth="2" markerStart="url(#arrow-start)" markerEnd="url(#arrow)"/>
      <text x="340" y="150" fill="#A855F7" fontFamily="system-ui, sans-serif" fontSize="10">solvers</text>

      {/* Dashed border around Train section - ON TOP */}
      <rect x="245" y="55" width="145" height="190" rx="6" fill="none" stroke="#A855F7" strokeWidth="1.5" strokeDasharray="6,4"/>
      <text x="317" y="260" fill="#A855F7" fontFamily="system-ui, sans-serif" fontSize="10" textAnchor="middle" opacity="0.8">Train Protocol</text>
    </svg>
  );
}
